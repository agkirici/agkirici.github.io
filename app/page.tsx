      ...
      <div className="mx-auto max-w-3xl space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-neutral-300 leading-relaxed">
            I started my career in genetic disease diagnostics and molecular biology wet-lab. 
            Later, I moved into cancer research where I worked as a data analyst on 
            multiple research projects. Today I combine biology, data analysis and software 
            development to create tools that people in healthcare and biotech actually use.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-neutral-300 leading-relaxed">
            I'm focusing on bioinformatics software development. I work with Python for data 
            processing, TypeScript and React for full-stack applications, and modern frameworks 
            that let me build clean and reliable interfaces. I use tools like Scanpy for 
            single-cell and spatial workflows and I write both frontend and backend logic 
        ...
        <section className="space-y-3">
          ...
          <p className="text-neutral-300 leading-relaxed">
            This website collects the projects I'm building at the intersection of biology, 
            data analysis and software. My goal is to create simple, focused applications that 
            make everyday research workflows easier.
          </p>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2 text-neutral-300">
            <h4 className="font-semibold text-neutral-100">Data management and knowledge graphs</h4>
            <p className="leading-relaxed">
              Some teams work with many sources of information such as genes, drugs, pathways, 
              protein interactions, diseases and clinical metadata. I'm interested in connecting 
              these layers with knowledge graphs so that relationships become easier to explore 
              and understand. Neo4j is one of the tools I use for this type of work.
            </p>
          </div>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2 text-neutral-300">
            ...
            <p className="leading-relaxed">
              ...
              application from start to finish. This includes data handling, backend logic 
              and the full interface.
            </p>
          </div>

          <div className="space-y-2 text-neutral-300">
            <h4 className="font-semibold text-neutral-100">Tool development and handover</h4>
            <p className="leading-relaxed">
          ...
          <div className="space-y-2 text-neutral-300">
            ...
            <p className="leading-relaxed">
              ...
              pipelines and architecture for projects in healthcare, spatial biology and biotech.
            </p>
          </div>
        </section>
