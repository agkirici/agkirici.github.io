...
export const metadata: Metadata = {
  ...
  title: "Arzu Kirici — Project Manager & Software Developer",
  description:
    "Project Manager and Software Developer specializing in healthcare, biotech, and software. Bridging technical and non-technical teams with TypeScript, React, and Node.js.",
  keywords: [
    "Arzu Kirici",
    "bioinformatics",
    "software engineer",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Arzu Kirici",
              description:
                "Project Manager and Software Developer specializing in healthcare, biotech, and software.",
              url: "https://arzukirici.com",
              sameAs: [
